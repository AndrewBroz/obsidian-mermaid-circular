...
Obsidian 1.13.0 or later. The layout needs mermaid internals that
arrived in mermaid 11.12, and 1.13.0 is the earliest Obsidian release
verified to bundle a new enough mermaid. On older builds the plugin
notices, tells you, and stays inactive rather than degrading quietly.
